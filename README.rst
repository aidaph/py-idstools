...
- The script u2kafka.py is the first version of a program to send records from Snort3 Unified2 files to kafka producer. This program converts u2 records to json for making Kafka produces them. 
